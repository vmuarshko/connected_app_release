 ...
 */
public class SplashFragment4 extends Fragment implements View.OnTouchListener {

    private final static String TAG = "SplashFragment3";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.splash_fragment_4, container, false);
